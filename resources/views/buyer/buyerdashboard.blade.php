...
<div class="wrapper">
  ...
  <nav style="background-color: #EEE3CB" class="main-header navbar navbar-expand  navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ url('buyer') }}" class="nav-link" style="color: #9BABB8">Home</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a style="color: #9BABB8" class="nav-link" data-widget="navbar-search" href="#" role="button">
  ...
  <aside style="background-color: #9BABB8" class="main-sidebar elevation-4">
    ...
    <div style="border-bottom: 1px solid #EEE3CB;">
        ...
        <a style="margin-left:15px; color:#EEE3CB; font-family:sans-serif;" href="{{ url('buyer') }}" class="brand-link">
